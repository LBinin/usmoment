...
writeFileSync(
  ...
  [
    'import { AccountingCalculator, AccountingCalculatorPopup, BusinessKeyboard, Popup, createExpressionEngine } from "@usmoment/taro";',
    'import "@usmoment/taro/style.css";',
    'import { AccountingCalculator as KitCalculator, AccountingCalculatorPopup as KitCalculatorPopup } from "@usmoment/taro/kit";',
    'import { BusinessKeyboard as UiKeyboard, Popup as UiPopup } from "@usmoment/taro/ui";',
    ...
    "if (typeof AccountingCalculatorPopup !== 'function') throw new Error('Missing AccountingCalculatorPopup');",
    "if (typeof BusinessKeyboard !== 'function') throw new Error('Missing BusinessKeyboard');",
    "if (typeof Popup !== 'function') throw new Error('Missing Popup');",
    ...
    "if (typeof KitCalculatorPopup !== 'function') throw new Error('Missing kit popup subpath');",
    "if (typeof UiKeyboard !== 'function') throw new Error('Missing ui subpath');",
    "if (typeof UiPopup !== 'function') throw new Error('Missing ui popup subpath');",
