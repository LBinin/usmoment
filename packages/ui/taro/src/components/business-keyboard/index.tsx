...
export function BusinessKeyboard(props: BusinessKeyboardProps) {
  ...
  return (
    ...
    >
      ...
      <View className="usm-business-keyboard__body">
        <View className="usm-business-keyboard__rows">
        ...
        {hasBodyOverlay ? (
          <View className="usm-business-keyboard__body-overlay">
            {props.bodyOverlay}
          </View>
        ) : null}
      </View>
