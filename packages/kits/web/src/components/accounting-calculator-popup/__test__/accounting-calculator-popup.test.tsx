...
import { AccountingCalculatorPopup as ExportedAccountingCalculatorPopup } from "../../../index";
...
describe("AccountingCalculatorPopup", () => {
  it("exports the accounting calculator popup kit component", () => {
    expect(ExportedAccountingCalculatorPopup).toBe(AccountingCalculatorPopup);
  });
